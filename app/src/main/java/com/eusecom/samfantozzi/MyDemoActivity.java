...
/**
 * Create new 2016 company.
 * Called from MainScreenActivity.java
 * Call ../androidfanti/create_demo2015.php
 */
...
public class MyDemoActivity extends Activity {
    ...
    String prmall, serverx, userx, mailxx, icox, nazovx, rokx;
        ...
        if (isOnline()) 
	     {
            ...
            btnPripoj.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    serverx = inputConServer.getText().toString();
                    mailxx = inputConMail.getText().toString();
                    icox = inputConIco.getText().toString();
                    nazovx = inputConNazov.getText().toString();
                    rokx = inputConRok.getText().toString();
                    userx = inputPriUser.getText().toString();
    ...
    class CreateMyDemo extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
        	...
        	//String decrypted = new String( mcrypt.decrypt( encrypted ) );
             ...
             HttpPost request = new HttpPost("http://" + serverxxx[0] + "/androidfanti/create_demo2015.php?sid=" + String.valueOf(Math.random()));
             ...
             if( akoreg.equals("0")) {
             	...
             	editor.putString("mydemo16", "1").apply();
