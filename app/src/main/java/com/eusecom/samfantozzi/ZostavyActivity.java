...
/**
 * Menu of acounting reports, tax reports and differwntly.
 * Called from MainScreenActivity.java
 * Layouts at ZostavyPageFragments.java
 */
...
public class ZostavyActivity extends FragmentActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if(mPager.getCurrentItem() == 0){ this.setTitle(getResources().getString(R.string.popisbtnzostavy)); }
        if(mPager.getCurrentItem() == 1){ this.setTitle(getResources().getString(R.string.popisbtndane)); }
        if(mPager.getCurrentItem() == 2){ this.setTitle(getResources().getString(R.string.popisbtnrozne)); }
