...
import java.io.OutputStreamWriter;
        ...
        public class defaultXML {
            ...
            public static int createdefaultXML(int xxx, String adresar, String firma)
            {
            	...
            	//1;2;Nakup materialu;5;0;0.00;0.00;2;1;0;0;2
            	...
            	if(!myFile2.exists()){
        			...
        			try {
						...
						OutputStreamWriter myOutWriter2 = new OutputStreamWriter(fOut2);
                    		...
                    		//1;30;Trzba tovar;1;0;0.00;0.00;1;1;0;0;30
                    		datatxt1 += "<ucet>";
                    		datatxt1 += "<prz>1</prz>";
                    		datatxt1 += "<uce>30</uce>";
            	...
            	//1;1;trzbu v hotovosti za tovar;9;1;30;51;30;60;30;55;34300;0;34300;0;0;0;0;0;;2011-02-01 13:19:18
            	...
            	if(!myFile3.exists()){
        			...
        			try {
						...
						OutputStreamWriter myOutWriter3 = new OutputStreamWriter(fOut3);
                    		...
                    		datatxt1 += "<uctpohyb>";
                    		datatxt1 += "<prz>1</prz>";
                    		datatxt1 += "<cpoh>1</cpoh>";
                    		datatxt1 += "<pohp>trzbu v hotovosti za tovar</pohp>";
                    		datatxt1 += "<ucto>9</ucto>";
                    		datatxt1 += "<druh>1</druh>";
                    		...
                    		datatxt1 += "<ddn1>60</ddn1>";
                    		datatxt1 += "<udn2>34300</udn2>";
                    		datatxt1 += "<ddn2>55</ddn2>";
                    		...
                    		//1;51;nakup materialu v hotovosti;9;2;2;1;2;30;2;25;34300;0;34300;0;0;0;0;0;;2011-02-01 13:19:18
                    		datatxt1 += "<uctpohyb>";
                    		datatxt1 += "<prz>1</prz>";
                    		datatxt1 += "<cpoh>51</cpoh>";
                    		datatxt1 += "<pohp>nakup materialu v hotovosti</pohp>";
                    		datatxt1 += "<ucto>9</ucto>";
                    		datatxt1 += "<druh>2</druh>";
                    		...
                    		datatxt1 += "<udn1>34300</udn1>";
                    		datatxt1 += "<ddn1>30</ddn1>";
                    		datatxt1 += "<udn2>34300</udn2>";
                    		datatxt1 += "<ddn2>25</ddn2>";
                    		datatxt1 += "<hfak>0</hfak>";
                    		datatxt1 += "<hico>0</hico>";
                    		datatxt1 += "<hstr>21100</hstr>";
                    		datatxt1 += "<hzak>21100</hzak>";
