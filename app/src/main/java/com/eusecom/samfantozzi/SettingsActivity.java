...
public class SettingsActivity extends android.preference.PreferenceActivity {
	...
	public static final String MYDEMO16 = "mydemo16";
	public static final String UPOMKTO = "upomkto";
	...
	public static String getMydemo16(Context ctx){
		return PreferenceManager.getDefaultSharedPreferences(ctx).getString(MYDEMO16, "0");
	}
	
	public static String getUpomkto(Context ctx){
		return PreferenceManager.getDefaultSharedPreferences(ctx).getString(UPOMKTO, "Sign");
	}
