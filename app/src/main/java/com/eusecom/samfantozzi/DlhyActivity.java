...
/**
 * Get customer's and suplier's liabilities.
...
public class DlhyActivity extends ListActivity implements SimpleGestureListener {
    ...
    EditText txtTitle;
    EditText txtValue;
    TextView hladaj1, hladaj2, hladaj3;
    String hladaj1x, hladaj2x, hladaj3x;
    TextView vybraneico;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //ak je pripojeny
        {
            ...
            if (icox.equals("0")) {
                if (cat.equals("8")) {
                    btnUce.setText(SettingsActivity.getOdbuce(this));
                }
                if (cat.equals("9")) {
                    btnUce.setText(SettingsActivity.getDoduce(this));
                }
            } else {
            ...
            btnUce.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (icox.equals("0")) {
                        ...
                        if (cat.equals("8")) {
                            extrasz.putString(TAG_ODKADE, "108");
                        }
                        if (cat.equals("9")) {
                            extrasz.putString(TAG_ODKADE, "109");
                        }
                        if (cat.equals("8")) {
                            extrasz.putString(TAG_POHX, "108");
                        }
                        if (cat.equals("9")) {
                            extrasz.putString(TAG_POHX, "109");
                        }
                        ...
                        if (ActivityCompat.checkSelfPermission(DlhyActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    case R.id.kontextupomsmsd:
    	if( icox.equals("0")) {}else{
    		...
    		int position = info.position;
    	 	...
    	 	fakx = vsyx;
    	 	//String dodx = "M-MAS s.r.o.";
    	 	String dodx = SettingsActivity.getUpomkto(this);
    	 	...
    	 	String smstextx= getResources().getString(R.string.upomsmstext1) + " " + getResources().getString(R.string.popisVsy) 
    	 			...
    	 			+ " " + hodx + getString(R.string.mena) + ", " + dodx;
