 ...
 * Called from context menu UpravPoklPolActivity.java
 * Call ../androidfanti/zmaz_poklpol.php
 */
...
public class ZmazPoklPolActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        serverx = inputEdiServer.getText().toString();
        userx = inputEdiUser.getText().toString();
        ...
        .setTitle(getString(R.string.okzmazdoklpol))
        .setMessage(getString(R.string.okzmazdoklpolmes))
        .setPositiveButton(getString(R.string.textyes), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) { 
                // continue with click
            	new ZmazDoklad().execute(prmall, serverx, userx);
            }
         })
    ...
    class ZmazDoklad extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ZmazPoklPolActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            HttpPost request = new HttpPost("http://" + serverxxx[0] + "/androidfanti/zmaz_poklpol.php?sid=" + String.valueOf(Math.random()));
