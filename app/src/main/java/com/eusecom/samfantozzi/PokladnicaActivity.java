 ...
 * Called from MainScreenctivity.java
 */
...
public class PokladnicaActivity extends ListActivity implements SimpleGestureListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //ak uzivatel 0 nepripojeny
       ...
       btnNext.setOnClickListener(new View.OnClickListener() {
        ...
        new LoadAllProducts().execute(prmall, serverx, userx, hladaj1x, hladaj2x, hladaj3x);
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
        	...
        	String[] serverxxx = serverx.split(delims);
        	String userx  = args[2];
        	String hladaj1x = args[3];
        	String hladaj2x = args[4];
        	String hladaj3x = args[5];
