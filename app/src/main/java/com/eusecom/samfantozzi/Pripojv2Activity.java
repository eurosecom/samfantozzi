...
public class Pripojv2Activity extends Activity {
    ...
    String server, nick, mail, serverx, userx;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnPripoj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                server = inputConServer.getText().toString();
                nick = inputConNick.getText().toString();
                mail = inputConMail.getText().toString();
                serverx = inputConServer.getText().toString();
                userx = inputPriUser.getText().toString();

                new CreatePripoj().execute(server, nick, mail, serverx, userx);
            }
        });
