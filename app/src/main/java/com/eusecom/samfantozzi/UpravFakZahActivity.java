...
/**
 * Edit head of accounting document.
 * Called from PokladnicaActivity.java
...
public class UpravFakZahActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uprav_fakzah);
        ...
        if( cat.equals("9")) {
        	textUce.setText(getResources().getString(R.string.popisbtndod1));
            }
        ...
        btnDat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                extrasz.putString(TAG_ODKADE, "14");
                iz.putExtras(extrasz);
                startActivityForResult(iz, 100);
        ...
        btnDaz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bundle extrasz = new Bundle();
                extrasz.putString("datx", dat);
                extrasz.putString(TAG_ODKADE, "15");
                iz.putExtras(extrasz);
                startActivityForResult(iz, 100);
        ...
        btnDas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bundle extrasz = new Bundle();
                extrasz.putString("datx", dat);
                extrasz.putString(TAG_ODKADE, "16");
                iz.putExtras(extrasz);
                startActivityForResult(iz, 100);
 ...
 // Response from VyberIcoActivity
    ...
    class GetProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(UpravFakZahActivity.this);
                    ...
                    try {
                        ...
                        if (success == 1) {
                           ...
                           // display product data in EditText
                            ...
                            inputDaz.setText(product.getString(TAG_DAZ));
                            inputDas.setText(product.getString(TAG_DAS));
                            inputKsy.setText(product.getString(TAG_KSY));
    ...
    class SaveProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UpravFakZahActivity.this);
