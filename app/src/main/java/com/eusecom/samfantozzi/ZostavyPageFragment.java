...
/**
 * Menu of acounting reports, tax reports and differently.
 * Layouts for ZostavyActivity.java
 */
            ...
            btnFob.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                	...
                	uri = Uri.parse("http://" + serverxxx[0] + 
                    		"/ucto/priznanie_fob2015.php?copern=10&drupoh=1&page=1&zandroidu=1&anduct=1&kli_vume=" + kli_vume + "&serverx=" 
